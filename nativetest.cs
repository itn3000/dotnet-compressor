...
{
    static FilePath GetNativeExePath(string configuration, string rid, string targetFramework)
    {
        string exeExtension = "";
    ...
    static void TestNativeTar(string configuration, string rid, string targetFramework)
    {
    ...
    static void TestNativeZip(string configuration, string rid, string targetFramework)
    {
        var exePath = GetNativeExePath(configuration, rid, targetFramework);
        var settings = new ProcessSettings()
        {
